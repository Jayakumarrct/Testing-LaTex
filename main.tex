...
% Section 13 portraits
\section{Figures and Portraits of Key Contributors}
This section collects portraits of mathematicians whose work underlies these notes. The images are public domain or Creative Commons and sourced from Wikimedia Commons.

\begin{figure}[h]
  \centering
  \begin{minipage}{0.45\textwidth}\centering
    \includegraphics[width=\linewidth]{assets/figures/people/noether_emmy_placeholder.pdf}
    \caption*{\textbf{Emmy Noether}. Placeholder --- image pending license check.}
  \end{minipage}\hfill
  \begin{minipage}{0.45\textwidth}\centering
    \includegraphics[width=\linewidth]{assets/figures/people/artin_emil_placeholder.pdf}
    \caption*{\textbf{Emil Artin}. Placeholder --- image pending license check.}
  \end{minipage}
\end{figure}
...
\begin{figure}[h]
  \centering
  \begin{minipage}{0.45\textwidth}\centering
    \includegraphics[width=\linewidth]{assets/figures/people/jawahiri_geeva_placeholder.pdf}
    \caption*{\textbf{Jawahiri, Geeva}. Placeholder --- image pending license check.}
  \end{minipage}
\end{figure}
